...
# Create NAT gateway 1 & allocate elastic ip 1
...
# Associate private app subnets with private route table 1
...
# Create NAT gateway 2 & allocate elastic ip 2
...
# Associate private app subnets with private route table 2
